                    ...
                    <div class="col-md-8">
                        <div class="blog-details">
                            ...
                            <div class="blog-details-content">
                                ...
                                <h6><?php echo strftime('Publicado el %d/%m/%Y a las %I:%M %p', strtotime($mostrar['fecha'])); ?></h6>
                    ...
                    <div class="col-md-4">
                        <div class="blog-sidebar right">
                            ...
                            <div class="single-blog-widget mb-47">
                                <h3>Empleos por año</h3>
                                <!-- Accordion -->
                                <div class="panel-group" id="accordion" role="tablist">
                                    <?php
                                    $cont=1;
                                    $sql="SELECT * FROM `empleos` ORDER BY fecha DESC";
                                    $resultado = mysqli_query($conexion, $sql);
                                    $año_anterior='9999';
